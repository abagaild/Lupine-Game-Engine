...
public:
    ...
    /**
     * @brief Get detailed error message explaining why exporter is unavailable
     * @return Error message, empty if available
     */
    virtual std::string GetAvailabilityError() const = 0;
...
public:
    ...
    /**
     * @brief Get all exporters regardless of availability
     * @return Vector of all exporters
     */
    std::vector<BaseExporter*> GetAllExporters() const;
