...
private:
    ...
    // Rendering resources
    std::shared_ptr<Lupine::GraphicsShader> m_face_shader;
    std::shared_ptr<Lupine::GraphicsShader> m_grid_shader;
    std::shared_ptr<Lupine::GraphicsShader> m_gizmo_shader;
