...
void Tilemap25DCanvas::setupShaders() {
    ...
    m_face_shader = std::make_unique<Lupine::OpenGLShader>(vertex_shader_source, fragment_shader_source);
    m_grid_shader = std::make_unique<Lupine::OpenGLShader>(vertex_shader_source, fragment_shader_source);
    m_gizmo_shader = std::make_unique<Lupine::OpenGLShader>(vertex_shader_source, fragment_shader_source);
}
